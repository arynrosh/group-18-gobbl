...
def create_order(order_id: str, customer_id: str, delivery_distance: int) -> dict:
    ...
    new_order = {
        ...
        "delivery_distance": delivery_distance, #Aryan needs to integrate this field with delivery assignment, note to self
...
def add_to_order(order_id: str, menu_item_id: int ,restaurant_id: int) -> dict:
    orders = load_all_orders()
    menu_items = load_all_menu()
